      ...
      {loading ? (
        ...
        <div className="card text-center py-16">
          <p className="text-[var(--text-3)]">
            {stats.length === 0
              // ========== BUG FIX 5: Cập nhật message từ 5 lần xuống 2 lần ==========
              // CŨ: 'Chưa có dữ liệu — câu hỏi cần được làm ít nhất 5 lần để hiện thống kê'
              // MỚI: Cập nhật thành 2 lần (vì đã giảm MIN_ATTEMPTS)
              ? 'Chưa có dữ liệu — câu hỏi cần được làm ít nhất 2 lần để hiện thống kê'
              // ========== END BUG FIX 5 ==========
