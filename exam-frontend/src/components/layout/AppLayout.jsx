...
function getNavItems(role) {
  const admin   = [
    ...
    { to: '/admin/questions',   label: 'Câu hỏi',                 icon: Icon.questions },
    { to: '/admin/tags',        label: 'Tags',                     icon: Icon.tags      },
    { to: '/admin/exams',       label: 'Bài kiểm tra',            icon: Icon.exams     },
    { to: '/admin/grading',     label: 'Chấm điểm',               icon: Icon.grading   },
    { to: '/admin/stats',       label: 'Thống kê',                icon: Icon.stats     },
